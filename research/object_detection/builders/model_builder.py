...
from object_detection.meta_architectures import center_net_meta_arch_trt
...
def _check_feature_extractor_exists(feature_extractor_type):
    ...
    if feature_extractor_type not in feature_extractors:
        raise ValueError(
            "{} is not supported. See `model_builder.py` for features "
...
def _build_center_net_trt_model(center_net_config, is_training, add_summaries):
    """Build a CenterNet detection model.
    ...
    return center_net_meta_arch_trt.CenterNetMetaArchTrt(
        is_training=is_training,
        add_summaries=add_summaries,
        num_classes=center_net_config.num_classes,
        feature_extractor=feature_extractor,
...
EXPERIMENTAL_META_ARCH_BUILDER_MAP = {"center_net_trt": _build_center_net_trt_model}
...
META_ARCH_BUILDER_MAP = {
    ...
    "center_net_trt": _build_center_net_trt_model,
}
